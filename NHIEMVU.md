<!-- 1. Hoàn thiện giao diện (HTML + CSS) -->

<!-- · Tinh chỉnh bố cục trang chủ (Home, About, Contact, v.v.) -->

<!-- · Dùng CSS Flexbox / Grid để căn chỉnh các phần tử. -->

<!-- · Thiết kế thanh menu điều hướng (navbar). -->

<!-- · Thêm footer và logo. -->

<!-- · Kiểm tra responsive design (hiển thị trên điện thoại, tablet). -->
...
· Tối ưu hiệu suất: nén ảnh, gộp file CSS/JS.

· Gợi ý chuẩn bị cho buổi triển khai website lên hosting
